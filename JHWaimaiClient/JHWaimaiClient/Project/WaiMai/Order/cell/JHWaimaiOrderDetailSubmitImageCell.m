//
//  JHWaimaiOrderDetailSubmitImageCell.m
...
@interface JHWaimaiOrderDetailSubmitImageCell()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
@end
@implementation JHWaimaiOrderDetailSubmitImageCell
