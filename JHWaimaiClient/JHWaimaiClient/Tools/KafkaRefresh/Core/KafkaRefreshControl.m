...
//static CGFloat const KafkaRefreshHeight = 64.;
static CGFloat const kStretchOffsetYAxisThreshold = 1.;
...
- (void)layoutSubviews{
	...
	self.kr_height = (self.kr_height < 45.) ? _KafkaRefreshHeight : self.kr_height;
