...
- (BOOL)jr_handleSave:(id<JRPersistent>)obj stack:(__strong NSMutableArray<id<JRPersistent>> **)stack needRollBack:(BOOL *)needRollBack {
...
- (id<JRPersistent>)jr_handleSingleLinkFindByID:(NSString *)ID clazz:(Class<JRPersistent>)clazz stack:(__strong NSMutableArray<id<JRPersistent>> **)stack{
